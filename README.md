...
表示が古い、または更新されない場合は、アプリ内の「すべて更新」を押してください (警報・地震・津波・雨雲・天気・各社予報・花粉をまとめて取り直します)。それでも変わらない場合は、ブラウザで再読み込みするか、ホーム画面から開いている場合はいったん閉じて開き直してください。

## Androidホーム画面ウィジェット

`android-widget/` には「12時間天気」ウィジェットが2種類入っています。どちらも見られる予報は同じ12時間で、1ページに載る時間数と幅が違います。

| 種類 | 大きさ | 1ページ | ページ数 |
| --- | --- | --- | --- |
| 12時間天気 | 縦2マス×横4マス | 4時間 | 3 |
| 12時間天気 (幅半分) | 縦2マス×横2マス | 2時間 | 6 |
